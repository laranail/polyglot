...
namespace Simtabi\Laranail\Polyglot\Support;
 ...
 *
 * Keys are relative to `laranail.polyglot.`, because every key here is.
 */
final readonly class PolyglotConfig
{
    private const string PREFIX = 'laranail.polyglot.';
