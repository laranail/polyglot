...
final class CallbackReplayTest extends TestCase
{
    ...
    {
        Event::fake([CallbackReceived::class]);
    ...
    public function test_the_same_delivery_twice_is_refused(): void
    {
        ...
        Event::fake([CallbackRejected::class]);

        $this->deliver(['task_id' => 't1'])->assertUnauthorized();

        Event::assertDispatched(
            CallbackRejected::class,
            fn (CallbackRejected $e): bool => $e->reason === RejectionReason::Replayed,
        );
    }
    ...
    public function test_a_forged_signature_is_refused(): void
    {
        ...
        Event::assertDispatched(
            CallbackRejected::class,
            fn (CallbackRejected $e): bool => $e->reason === RejectionReason::SignatureMismatch,
        );
    }
    ...
    public function test_a_stale_timestamp_is_refused(): void
    {
        ...
        Event::assertDispatched(
            CallbackRejected::class,
            fn (CallbackRejected $e): bool => $e->reason === RejectionReason::TimestampOutOfRange,
        );
    }
    ...
    {
        config()->set('laranail.polyglot.callbacks.max_body_bytes', 32);
    ...
    {
        config()->set('laranail.polyglot.callbacks.secrets', ['the-new-secret-value', self::SECRET]);
        $this->app->forgetInstance(CallbackVerifier::class);
