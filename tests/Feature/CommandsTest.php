...
final class CommandsTest extends TestCase
{
    public function test_doctor_reports_a_problem_and_exits_non_zero(): void
    {
        ...
        $this->artisan('laranail::polyglot.doctor')->assertExitCode(1);
    }
    ...
    public function test_doctor_is_clean_when_every_service_answers(): void
    {
        ...
        $this->artisan('laranail::polyglot.doctor')->assertExitCode(0);
    }
    ...
    public function test_health_exits_non_zero_when_a_service_is_down(): void
    {
        ...
        $this->artisan('laranail::polyglot.health')->assertExitCode(1);
    }
    ...
    public function test_health_exits_zero_when_everything_answers(): void
    {
        ...
        $this->artisan('laranail::polyglot.health')->assertExitCode(0);
    }

    public function test_health_refuses_an_unknown_service(): void
    {
        $this->artisan('laranail::polyglot.health', ['--service' => 'nope'])->assertExitCode(1);
    }

    public function test_run_refuses_while_the_process_transport_is_disabled(): void
    {
        $this->artisan('laranail::polyglot.run', ['script' => 'anything'])->assertExitCode(1);
    }
    ...
    {
        $this->artisan('laranail::polyglot.make-service', ['name' => '../escape'])->assertExitCode(1);
    }
    ...
    public function test_make_service_refuses_to_overwrite_without_force(): void
    {
        ...
        $this->artisan('laranail::polyglot.make-service', ['name' => 'dup', '--force' => true])->assertExitCode(0);
